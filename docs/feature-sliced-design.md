...
- [Feature-Sliced Design](/index.md)
...
- [🧭 Navigation](/nav.md): Feature-Sliced Design Navigation help page
...
- [Needs driven](/docs/about/understanding/needs-driven.md): — Can't you formulate the goal that the new feature will solve? Or maybe the problem is that the task itself is not formulated? **The point is also that the methodology helps to pull out the problematic definition of tasks and goals**
...
- [Page layouts](/docs/guides/examples/page-layout.md): This guide examines the abstraction of a page layout — when several pages share the same overall structure, and differ only in the main content.
...
- [Cross-import](/docs/guides/issues/cross-imports.md): A cross-import is an import between different slices within the same layer.
...
- [Migration from v2.0 to v2.1](/docs/guides/migration/from-v2-0.md): The main change in v2.1 is the new mental model for decomposing an interface — pages first.
...
- [Usage with Next.js](/docs/guides/tech/with-nextjs.md): FSD is compatible with Next.js in both the App Router version and the Pages Router version if you solve the main conflict — the app and pages folders.
...
- [Usage with React Query](/docs/guides/tech/with-react-query.md): The problem of “where to put the keys”
...
![](/assets/ideal-img/tiny-bunny.dd60f55.640.png)
...
[Tutorial](/docs/get-started/tutorial.md)

[**old**:](/docs/get-started/tutorial.md)

<!-- -->

<!-- -->

[/docs/get-started/quick-start](/docs/get-started/tutorial.md)

[**new**: ](/docs/get-started/tutorial.md)

<!-- -->

[/docs/get-started/tutorial](/docs/get-started/tutorial.md)

[Basics](/docs/get-started/overview.md)

[**old**:](/docs/get-started/overview.md)

<!-- -->

<!-- -->

[/docs/get-started/basics](/docs/get-started/overview.md)

[**new**: ](/docs/get-started/overview.md)

<!-- -->

[/docs/get-started/overview](/docs/get-started/overview.md)

[Decompose Cheatsheet](/docs/get-started/cheatsheet.md)

[**old**:](/docs/get-started/cheatsheet.md)

<!-- -->

<!-- -->

[/docs/get-started/tutorial/decompose; /docs/get-started/tutorial/design-mockup; /docs/get-started/onboard/cheatsheet](/docs/get-started/cheatsheet.md)

[**new**: ](/docs/get-started/cheatsheet.md)

<!-- -->

[/docs/get-started/cheatsheet](/docs/get-started/cheatsheet.md)

### 🍰 Alternatives

⚡️ <!-- -->Moved and merged to /about/alternatives as advanced materials

[Architecture approaches alternatives](/docs/about/alternatives.md)

[**old**:](/docs/about/alternatives.md)

<!-- -->

<!-- -->

[/docs/about/alternatives/big-ball-of-mud; /docs/about/alternatives/design-principles; /docs/about/alternatives/ddd; /docs/about/alternatives/clean-architecture; /docs/about/alternatives/frameworks; /docs/about/alternatives/atomic-design; /docs/about/alternatives/smart-dumb-components; /docs/about/alternatives/feature-driven](/docs/about/alternatives.md)

[**new**: ](/docs/about/alternatives.md)

<!-- -->

[/docs/about/alternatives](/docs/about/alternatives.md)

### 🍰 Promote & Understanding

⚡️ <!-- -->Moved to /about as advanced materials

[Knowledge types](/docs/about/understanding/knowledge-types.md)

[**old**:](/docs/about/understanding/knowledge-types.md)

<!-- -->

<!-- -->

[/docs/reference/knowledge-types](/docs/about/understanding/knowledge-types.md)

[**new**: ](/docs/about/understanding/knowledge-types.md)

<!-- -->

[/docs/about/understanding/knowledge-types](/docs/about/understanding/knowledge-types.md)

[Needs driven](/docs/about/understanding/needs-driven.md)

[**old**:](/docs/about/understanding/needs-driven.md)

<!-- -->

<!-- -->

[/docs/concepts/needs-driven](/docs/about/understanding/needs-driven.md)

[**new**: ](/docs/about/understanding/needs-driven.md)

<!-- -->

[/docs/about/understanding/needs-driven](/docs/about/understanding/needs-driven.md)

[About architecture](/docs/about/understanding/architecture.md)

[**old**:](/docs/about/understanding/architecture.md)

<!-- -->

<!-- -->

[/docs/concepts/architecture](/docs/about/understanding/architecture.md)

[**new**: ](/docs/about/understanding/architecture.md)

<!-- -->

[/docs/about/understanding/architecture](/docs/about/understanding/architecture.md)

[Naming adaptability](/docs/about/understanding/naming.md)

[**old**:](/docs/about/understanding/naming.md)

<!-- -->

<!-- -->

[/docs/concepts/naming-adaptability](/docs/about/understanding/naming.md)

[**new**: ](/docs/about/understanding/naming.md)

<!-- -->

[/docs/about/understanding/naming](/docs/about/understanding/naming.md)

[Signals of architecture](/docs/about/understanding/signals.md)

[**old**:](/docs/about/understanding/signals.md)

<!-- -->

<!-- -->

[/docs/concepts/signals](/docs/about/understanding/signals.md)

[**new**: ](/docs/about/understanding/signals.md)

<!-- -->

[/docs/about/understanding/signals](/docs/about/understanding/signals.md)

[Abstractions of architecture](/docs/about/understanding/abstractions.md)

[**old**:](/docs/about/understanding/abstractions.md)

<!-- -->

<!-- -->

[/docs/concepts/abstractions](/docs/about/understanding/abstractions.md)

[**new**: ](/docs/about/understanding/abstractions.md)

<!-- -->

[/docs/about/understanding/abstractions](/docs/about/understanding/abstractions.md)

### 📚 Reference guidelines (isolation & units)

⚡️ <!-- -->Moved to /reference as theoretical materials (old concepts)

[Decouple of entities](/docs/reference/layers.md#import-rule-on-layers)

[**old**:](/docs/reference/layers.md#import-rule-on-layers)

<!-- -->

<!-- -->

[/docs/concepts/decouple-entities](/docs/reference/layers.md#import-rule-on-layers)

[**new**: ](/docs/reference/layers.md#import-rule-on-layers)

<!-- -->

[/docs/reference/layers#import-rule-on-layers](/docs/reference/layers.md#import-rule-on-layers)

[Low Coupling & High Cohesion](/docs/reference/slices-segments.md#zero-coupling-high-cohesion)

[**old**:](/docs/reference/slices-segments.md#zero-coupling-high-cohesion)

<!-- -->

<!-- -->

[/docs/concepts/low-coupling](/docs/reference/slices-segments.md#zero-coupling-high-cohesion)

[**new**: ](/docs/reference/slices-segments.md#zero-coupling-high-cohesion)

<!-- -->

[/docs/reference/slices-segments#zero-coupling-high-cohesion](/docs/reference/slices-segments.md#zero-coupling-high-cohesion)

[Cross-communication](/docs/reference/layers.md#import-rule-on-layers)
...
[/docs/concepts/cross-communication](/docs/reference/layers.md#import-rule-on-layers)
...
[App splitting](/docs/reference/layers.md)

[**old**:](/docs/reference/layers.md)

<!-- -->

<!-- -->

[/docs/concepts/app-splitting](/docs/reference/layers.md)

[**new**: ](/docs/reference/layers.md)

<!-- -->

[/docs/reference/layers](/docs/reference/layers.md)

[Decomposition](/docs/reference/layers.md)
...
[/docs/reference/units/decomposition](/docs/reference/layers.md)
...
[Units](/docs/reference/layers.md)
...
[/docs/reference/units](/docs/reference/layers.md)
...
[Layers](/docs/reference/layers.md)
...
[/docs/reference/units/layers](/docs/reference/layers.md)
...
[Layer overview](/docs/reference/layers.md)
...
[/docs/reference/layers/overview](/docs/reference/layers.md)
...
[App layer](/docs/reference/layers.md)
...
[/docs/reference/units/layers/app](/docs/reference/layers.md)
...
[Processes layer](/docs/reference/layers.md)
...
[/docs/reference/units/layers/processes](/docs/reference/layers.md)
...
[Pages layer](/docs/reference/layers.md)
...
[/docs/reference/units/layers/pages](/docs/reference/layers.md)
...
[Widgets layer](/docs/reference/layers.md)
...
[/docs/reference/units/layers/widgets](/docs/reference/layers.md)
...
[/docs/reference/layers/widgets](/docs/reference/layers.md)
...
[Features layer](/docs/reference/layers.md)
...
[/docs/reference/units/layers/features](/docs/reference/layers.md)
...
[Entities layer](/docs/reference/layers.md)
...
[/docs/reference/units/layers/entities](/docs/reference/layers.md)
...
[Shared layer](/docs/reference/layers.md)
...
[/docs/reference/units/layers/shared](/docs/reference/layers.md)
...
[Segments](/docs/reference/slices-segments.md)

[**old**:](/docs/reference/slices-segments.md)

<!-- -->

<!-- -->

[/docs/reference/units/segments](/docs/reference/slices-segments.md)

[**new**: ](/docs/reference/slices-segments.md)

<!-- -->

[/docs/reference/slices-segments](/docs/reference/slices-segments.md)

### 🎯 Bad Practices handbook

⚡️ <!-- -->Moved to /guides as practice materials

[Cross-imports](/docs/guides/issues/cross-imports.md)

[**old**:](/docs/guides/issues/cross-imports.md)

<!-- -->

<!-- -->

[/docs/concepts/issues/cross-imports](/docs/guides/issues/cross-imports.md)

[**new**: ](/docs/guides/issues/cross-imports.md)

<!-- -->

[/docs/guides/issues/cross-imports](/docs/guides/issues/cross-imports.md)

[Desegmented](/docs/guides/issues/desegmented.md)

[**old**:](/docs/guides/issues/desegmented.md)

<!-- -->

<!-- -->

[/docs/concepts/issues/desegmented](/docs/guides/issues/desegmented.md)

[**new**: ](/docs/guides/issues/desegmented.md)

<!-- -->

[/docs/guides/issues/desegmented](/docs/guides/issues/desegmented.md)

[Routes](/docs/guides/issues/routes.md)

[**old**:](/docs/guides/issues/routes.md)

<!-- -->

<!-- -->

[/docs/concepts/issues/routes](/docs/guides/issues/routes.md)

[**new**: ](/docs/guides/issues/routes.md)

<!-- -->

[/docs/guides/issues/routes](/docs/guides/issues/routes.md)

### 🎯 Examples

⚡️ <!-- -->Grouped and simplified into /guides/examples as practical examples

[Viewer logic](/docs/guides/examples/auth.md)

[**old**:](/docs/guides/examples/auth.md)

<!-- -->

<!-- -->

[/docs/guides/examples/viewer](/docs/guides/examples/auth.md)

[**new**: ](/docs/guides/examples/auth.md)

<!-- -->

[/docs/guides/examples/auth](/docs/guides/examples/auth.md)

[Monorepo](/docs/guides/examples/monorepo.md)

[**old**:](/docs/guides/examples/monorepo.md)

<!-- -->

<!-- -->

[/docs/guides/monorepo](/docs/guides/examples/monorepo.md)

[**new**: ](/docs/guides/examples/monorepo.md)

<!-- -->

[/docs/guides/examples/monorepo](/docs/guides/examples/monorepo.md)

[White Labels](/docs/guides/examples/white-labels.md)

[**old**:](/docs/guides/examples/white-labels.md)

<!-- -->

<!-- -->

[/docs/guides/white-labels](/docs/guides/examples/white-labels.md)

[**new**: ](/docs/guides/examples/white-labels.md)

<!-- -->

[/docs/guides/examples/white-labels](/docs/guides/examples/white-labels.md)
...
[**old**:](/docs/guides/migration/from-v1.md)

<!-- -->

<!-- -->

[/docs/guides/migration-from-v1](/docs/guides/migration/from-v1.md)

[**new**: ](/docs/guides/migration/from-v1.md)

<!-- -->

[/docs/guides/migration/from-v1](/docs/guides/migration/from-v1.md)

[Migration from Legacy](/docs/guides/migration/from-custom.md)

[**old**:](/docs/guides/migration/from-custom.md)

<!-- -->

<!-- -->

[/docs/guides/migration-from-legacy](/docs/guides/migration/from-custom.md)

[**new**: ](/docs/guides/migration/from-custom.md)

<!-- -->

[/docs/guides/migration/from-custom](/docs/guides/migration/from-custom.md)

### 🎯 Tech

⚡️ <!-- -->Grouped into /guides/tech as tech-specific usage guidelines

[Usage with NextJS](/docs/guides/tech/with-nextjs.md)

[**old**:](/docs/guides/tech/with-nextjs.md)

<!-- -->

<!-- -->

[/docs/guides/usage-with-nextjs](/docs/guides/tech/with-nextjs.md)

[**new**: ](/docs/guides/tech/with-nextjs.md)

<!-- -->

[/docs/guides/tech/with-nextjs](/docs/guides/tech/with-nextjs.md)

### Rename 'legacy' to 'custom'

⚡️ <!-- -->'Legacy' is derogatory, we don't get to call people's projects legacy

[Rename 'legacy' to custom](/docs/guides/migration/from-custom.md)
...
[Isolation of modules](/docs/reference/layers.md#import-rule-on-layers)
...
[/docs/reference/isolation](/docs/reference/layers.md#import-rule-on-layers)
...
| v2.1 | [Release Notes](https://github.com/feature-sliced/documentation/releases/tag/v2.1) | [Documentation](/docs/get-started/overview.md) | [Migration from v1](/docs/guides/migration/from-v1.md) | [Migration from v2.0](/docs/guides/migration/from-v1.md) |
| ---- | ---------------------------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------ | -------------------------------------------------------- |
...
| v1.0 | [Documentation](https://feature-sliced.design/featureslices.dev/v1.0.html) |
| ---- | -------------------------------------------------------------------------- |
| v0.1 | [Documentation](https://feature-sliced.design/featureslices.dev/v0.1.html) |
...
[Core-team, Champions, Contributors, Companies](/community/team.md)

[Brandbook](/docs/branding.md)

[Recommendations for FSD's branding usage](/docs/branding.md)
...
* 📢 Share your feedback [at article (comment/emoji-reaction)](https://github.com/feature-sliced/documentation/issues/192)
...
## Core-team[​](#core-team "Direct link to heading")

### Champions[​](#champions "Direct link to heading")

## Contributors[​](#contributors "Direct link to heading")

## Companies[​](#companies "Direct link to heading")
...
* 📢 Share your feedback [at article (comment/emoji-reaction)](https://github.com/feature-sliced/documentation/issues/214)
* 💬 Collect the relevant [material on the topic from chat](https://t.me/feature_sliced)
* ⚒️ Contribute [in any other way](https://github.com/feature-sliced/documentation/blob/master/CONTRIBUTING.md)
...
* 📢 Share your feedback [at article (comment/emoji-reaction)](https://github.com/feature-sliced/documentation/issues/58)
* 💬 Collect the relevant [material on the topic from chat](https://t.me/feature_sliced)
* ⚒️ Contribute [in any other way](https://github.com/feature-sliced/documentation/blob/master/CONTRIBUTING.md)
...
Obviously, this will not be a silver bullet, and of course, the methodology will have its own [limits of applicability](/docs/about/mission.md).
...
The main part of the goals [is set out here](/docs/about/mission.md#goals), but in addition, it is worth talking about our expectations from the methodology in the future
...
* [About the methodology's mission: goals and limitations](/docs/about/mission.md)
* [Types of knowledge in the project](/docs/about/understanding/knowledge-types.md)
...
* 📢 Share your feedback [at article (comment/emoji-reaction)](https://github.com/feature-sliced/documentation/issues/197)
* 💬 Collect the relevant [material on the topic from chat](https://t.me/feature_sliced)
* ⚒️ Contribute [in any other way](https://github.com/feature-sliced/documentation/blob/master/CONTRIBUTING.md)
...
Sometimes you want to include certain business logic in the layout, especially if you're using deeply nested routes with a router like [React Router](https://reactrouter.com/). Then you can't store the layout in Shared or in Widgets due to [the import rule on layers](/docs/reference/layers.md#import-rule-on-layers):
...
* There's an example of how to build a layout with authentication with React and Remix (equivalent to React Router) in the [tutorial](/docs/get-started/tutorial.md).
...
* 📢 Share your feedback [at article (comment/emoji-reaction)](https://github.com/feature-sliced/documentation/issues/198)
* 💬 Collect the relevant [material on the topic from chat](https://t.me/feature_sliced)
* ⚒️ Contribute [in any other way](https://github.com/feature-sliced/documentation/blob/master/CONTRIBUTING.md)
...
* 📢 Share your feedback [at article (comment/emoji-reaction)](https://github.com/feature-sliced/documentation/issues/173)
* 💬 Collect the relevant [material on the topic from chat](https://t.me/feature_sliced)
* ⚒️ Contribute [in any other way](https://github.com/feature-sliced/documentation/blob/master/CONTRIBUTING.md)
...
You might notice that the `Song` type references a different entity, `Artist`. This is a benefit of storing your requests in Shared — real-world types are often intertwined. If we kept this function in `entities/song/api`, we wouldn't be able to simply import `Artist` from `entities/artist`, because FSD restricts cross-imports between slices with [the import rule on layers](/docs/reference/layers.md#import-rule-on-layers):
...
It would be nice to have typed Redux hooks `useAppDispatch` and `useAppSelector` in `shared/store`, but they cannot import `RootState` and `AppDispatch` from the App layer due to the [import rule on layers](/docs/reference/layers.md#import-rule-on-layers):
...
## Type validation schemas and Zod[​](#type-validation-schemas-and-zod "Direct link to heading")
...
## Ambient declaration files (`*.d.ts`)[​](#ambient-declaration-files-dts "Direct link to heading")
