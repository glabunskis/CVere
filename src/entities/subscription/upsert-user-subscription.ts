...
import { supabaseAdminClient } from '@/shared/api/supabase/supabase-admin';
import type { Database } from '@/shared/api/supabase/types';
import { toDateTime } from '@/shared/lib/to-date-time';
...
export async function upsertUserSubscription({
  ...
  // In Stripe dahlia API, current_period_start/end moved to subscription items
  ...
  const subscriptionData: Database['public']['Tables']['subscriptions']['Insert'] = {
    ...
    current_period_start: toDateTime(subscriptionItem.current_period_start).toISOString(),
    current_period_end: toDateTime(subscriptionItem.current_period_end).toISOString(),
